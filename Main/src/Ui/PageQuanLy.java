...
public class PageQuanLy extends JFrame {
    ...
    private void LoadTable() {
        String[] columnNames = {"Username", "Password", "Ho ten", "SDT", "NgaySinh"};
    ...
    private void themnhanvien() {
        ...
        NhanVien nv = new NhanVien();
        boolean ok = nv.ThemThongTinNhanVien(username, password, hoten, sdt, ngaysinh);
    ...
    private void clickTableNhanVien() {
        ...
        String password = model.getValueAt(row, 1).toString();
